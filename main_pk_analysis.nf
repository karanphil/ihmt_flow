...
process Compute_ihMT_B1 {
    ...
    file "${sid}__negative_b1_warped.nii.gz"
    file "${sid}__positive_b1_warped.nii.gz"
    file "${sid}__altnp_b1_warped.nii.gz"
    file "${sid}__altpn_b1_warped.nii.gz"
    file "${sid}__reference_b1_warped.nii.gz"
    file "${sid}__T1w_b1_warped.nii.gz"
...
process Compute_ihMT {
    ...
    file "${sid}__negative_warped.nii.gz"
    file "${sid}__positive_warped.nii.gz"
    file "${sid}__altnp_warped.nii.gz"
    file "${sid}__altpn_warped.nii.gz"
    file "${sid}__reference_warped.nii.gz"
    file "${sid}__T1w_warped.nii.gz"
    ...
    antsApplyTransforms -d 3 -i Contrasts_ihMT_maps/*_positive*.nii.gz\
        -r !{sid}__MTsat_warped.nii.gz \
        -o !{sid}__positive_warped.nii.gz -n Linear \
        -t !{sid}__output1Warp.nii.gz !{sid}__output0GenericAffine.mat

    antsApplyTransforms -d 3 -i Contrasts_ihMT_maps/*negative*.nii.gz\
        -r !{sid}__MTsat_warped.nii.gz \
        -o !{sid}__negative_warped.nii.gz -n Linear \
        -t !{sid}__output1Warp.nii.gz !{sid}__output0GenericAffine.mat

    antsApplyTransforms -d 3 -i Contrasts_ihMT_maps/*altnp*.nii.gz\
        -r !{sid}__MTsat_warped.nii.gz \
        -o !{sid}__altnp_warped.nii.gz -n Linear \
        -t !{sid}__output1Warp.nii.gz !{sid}__output0GenericAffine.mat

    antsApplyTransforms -d 3 -i Contrasts_ihMT_maps/*altpn*.nii.gz\
       -r !{sid}__MTsat_warped.nii.gz \
       -o !{sid}__altpn_warped.nii.gz -n Linear \
       -t !{sid}__output1Warp.nii.gz !{sid}__output0GenericAffine.mat

    antsApplyTransforms -d 3 -i Contrasts_ihMT_maps/*reference*.nii.gz\
       -r !{sid}__MTsat_warped.nii.gz \
       -o !{sid}__reference_warped.nii.gz -n Linear \
       -t !{sid}__output1Warp.nii.gz !{sid}__output0GenericAffine.mat

    antsApplyTransforms -d 3 -i Contrasts_ihMT_maps/*T1w*.nii.gz\
       -r !{sid}__MTsat_warped.nii.gz \
       -o !{sid}__T1w_warped.nii.gz -n Linear \
       -t !{sid}__output1Warp.nii.gz !{sid}__output0GenericAffine.mat
    '''
}
